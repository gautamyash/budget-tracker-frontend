    ...
    <div style={{
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <h1 style={{ color: "white", fontSize: "2.25rem", fontWeight: 800, letterSpacing: "-0.025em" }}>
            StashDash
          </h1>
        ...
        <div style={{
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            {error && (
              <motion.div 
                ...
                style={{ color: "#f87171", fontSize: "0.875rem", textAlign: "center" }}
              >
                {error}
              </motion.div>
            )}
          ...
          <div style={{ marginTop: "32px", textAlign: "center" }}>
            <p style={{ color: "#64748b", fontSize: "0.875rem" }}>
              Demo access: <span style={{ color: "#94a3b8" }}>admin / admin123</span>
            </p>
          </div>
        </div>

        <p style={{ textAlign: "center", color: "#475569", marginTop: "32px", fontSize: "0.875rem" }}>
